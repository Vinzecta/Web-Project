...
function Introduction() {
    return (
        <section className="flex flex-col w-[80%] gap-5 mt-10 ml-[10%]" id="introduction-section">
            <p className={`text-sm w-fit text-[#C25C5C] ${workSans.className} font-medium`}>About ShopName</p>
            ...
            <div className="flex w-[100%] gap-5" id="image-intro">
                ...
                <div className="flex flex-col justify-end gap-5 w-1/2" id="right-intro">
                    ...
                    <h3 className="text-2xl text-[#C25C5C] font-medium">Welcome to Ceramic Shop, where passion meets craftsmanship to bring you a world of timeless beauty and creativity.</h3>

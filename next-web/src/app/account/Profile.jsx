        ...
        <form className="w-[60%] mt-5 p-5 flex flex-col gap-5 rounded-2xl border border-gray-300 border-opacity-50 mb-10" id="profile-form">
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex justify-between basic-info">
                    <div className="w-[45%] flex flex-col gap-2 flex-info">
                        ...
                        <input className={`bg-[white] h-[50px] px-3 border border-gray-300 border-opacity-50 w-[100%] ${workSans.className} font-normal`}></input>
                    </div>
                ...
                <div className="flex justify-between basic-info">
                    <div className="w-[45%] flex flex-col gap-2 flex-info">
                        <label className={`${workSans.className} text-[#424b4a] font-bold`}>Username <span className="text-[red]">*</span></label>
                        <input className={`bg-[white] h-[50px] px-3 border border-gray-300 border-opacity-50 w-[100%] ${workSans.className} font-normal`}></input>
                    </div>
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input type="text" className={`bg-[white] h-[50px] px-3 border border-gray-300 border-opacity-50 w-[100%] ${workSans.className} font-normal`}></input>
                </div>

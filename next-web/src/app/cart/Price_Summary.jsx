        ...
        <>
            <section className="w-[80%] mt-10 mx-auto">
                ...
                <div className="p-15 flex flex-col gap-5 mt-10 shadow-[0_8px_30px_rgb(0,0,0,0.12)] rounded-2xl bill-card">
                    ...
                    <button onClick={() => setOpenMethod(true)} className={`text-base w-fit py-3 px-5 text-center border banner-p text-[#C25C5C] rounded-3xl mx-auto border-[#C25C5C] font-medium ${workSans.className} hover:bg-[#C25C5C] hover:text-white delay-75 duration-300 flex justify-center items-center`}>Add more payment method</button>
                </div>
            ...
            <AnimatePresence>
                    {openMethod ? <PaymentMethod onClose={() => setOpenMethod(false)} /> : undefined}
            </AnimatePresence>
        </>
    );
}
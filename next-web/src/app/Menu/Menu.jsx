    ...
    return (
        <section className="h-screen w-[100%] fixed bg-[#00000066] top-0 z-50">
            <div className={`h-[100%] w-[35%] bg-white ml-auto flex flex-col transition-transform duration-500 ease-in-out ${animationClass}`} id="menu-container">
                ...
                <div>
                    <div className="w-[100%]">
                        <button className="hidden w-[100%] flex justify-between px-5 py-3" onClick={() => setOpenNav(prev => !prev)} id="navigation-container">
                            <KeyboardArrowDownIcon className={`text-[#424b4a] ${openNav ? "rotate-180" : undefined}`} />

                            <div className="flex gap-3">
                                <p className={`${workSans.className} text-normal font-normal text-[#424b4a] uppercase`}>Navigation</p>
                                <NavigationOutlinedIcon className={`text-[#424b4a] rotate-270`} />
                            </div>
                        </button>

                        {openNav ? <nav className="flex flex-col text-center">
                                        <Link href="/home" className={`${workSans.className} font-normal text-normal text-[#424b4a] uppercase px-5 py-3 border-t border-gray-300 border-opacity-50`}>Home</Link>
                                        <Link href="/home" className={`${workSans.className} font-normal text-normal text-[#424b4a] uppercase px-5 py-3`}>About</Link>
                                        <Link href="/home" className={`${workSans.className} font-normal text-normal text-[#424b4a] uppercase px-5 py-3`}>Shop</Link>
                                        <Link href="/home" className={`${workSans.className} font-normal text-normal text-[#424b4a] uppercase px-5 py-3 border-b border-gray-300 border-opacity-50`}>Contact</Link>
                                    </nav> : undefined}
                        ...
                        <Link href="/account" className="flex gap-3 font-medium text-[#424b4a] justify-end px-5 py-3 hover:bg-[#C25C5C] hover:text-white delay-75 duration-300">
                            <p className={`text-normal ${workSans.className} font-normal uppercase`}>Account</p>
                        ...
                        <Link href="/cart" className="hidden flex gap-3 font-medium text-[#424b4a] justify-end px-5 py-3 hover:bg-[#C25C5C] hover:text-white delay-75 duration-300" id="cart-nav">
                            <p className={`text-normal ${workSans.className} font-normal uppercase`}>Cart</p>
                        ...
                        <Link href="/" className="flex gap-3 justify-end font-medium text-[#424b4a] px-5 py-3 hover:bg-[#C25C5C] hover:text-white delay-75 duration-300">
                            <p className={`text-normal uppercase ${workSans.className} font-normal`}>Sign Out</p>
